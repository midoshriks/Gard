    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Create PepsiPlastic</h4>
            ...
            {{-- modal-body --}}
            <form action="{{ route('dashboard.pepsiplastic.store') }}" method="post">
                @csrf
                @method('POST')
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control form-control-lg mb-2" name="first_term_B" type="number"
                        placeholder="First term" {{ $row_first_term->first() == null ? ' ' : 'disabled' }}>
